...
test("Interrupt hook command is absolute, quoted, and bound to the exact application home", () => {
  expect(codexInterruptHookCommand(
    { runtimeCommand: ["/Applications/MoreCodex.app/runtime/bun", "/Applications/MoreCodex.app/app/cli.js"] },
    "/Users/test/Application Support/MoreCodex",
    "darwin",
  )).toBe(
    "'/Applications/MoreCodex.app/runtime/bun' '/Applications/MoreCodex.app/app/cli.js'"
      + " '--home' '/Users/test/Application Support/MoreCodex' 'hook' 'interrupt'",
  );
  expect(codexInterruptHookCommand(
    { runtimeCommand: ["C:\\Program Files\\MoreCodex\\bun.exe", "C:\\Program Files\\MoreCodex\\cli.js"] },
    "C:\\Users\\test\\MoreCodex",
    "win32",
  )).toBe(
    "& 'C:\\Program Files\\MoreCodex\\bun.exe' 'C:\\Program Files\\MoreCodex\\cli.js'"
      + " '--home' 'C:\\Users\\test\\MoreCodex' 'hook' 'interrupt'",
  );
});
