...
test("installed launcher discovery has explicit platform candidates", () => {
  expect(installedLauncherCandidates({
    ...
    "/Users/tester/Applications/MoreCodex.app/Contents/MacOS/MoreCodex",
  ]);
  expect(installedLauncherCandidates({
    platform: "linux",
  ...
  expect(installedLauncherCandidates({
    ...
    "C:\\Users\\tester\\AppData\\Local\\Programs\\MoreCodex\\MoreCodex.exe",
  ]);
  expect(installedLauncherCandidates({
    platform: "win32",
    homeDirectory: "C:\\Users\\tester",
    environment: { LOCALAPPDATA: "C:\\Users\\tester\\AppData\\Local" },
    windowsInstallLocation: "D:\\Apps\\MoreCodex",
  })).toEqual([
    "D:\\Apps\\MoreCodex\\MoreCodex.exe",
  ]);
});
...
test("injected Windows discovery avoids the live registry while ordinary discovery still uses it", () => {
  ...
  const registry = spyOn(childProcess, "execFileSync").mockImplementation((() =>
    "    InstallLocation    REG_SZ    D:\\Installed\\MoreCodex\n"
