...
const en = {
  ...
  supportBody: "Star MoreCodex on GitHub. You can also visit the original bridge author's X profile.",
  star: "Star on GitHub",
  starred: "GitHub opened",
  follow: "Upstream author's X",
  followed: "X opened",
...
const zh: Record<keyof typeof en, string> = {
  ...
  continue: "继续",
  supportTitle: "开始之前",
  supportBody: "欢迎为 MoreCodex 仓库点 Star。也可以访问原项目作者的 X 主页。",
...
const ja: Record<keyof typeof en, string> = {
  ...
  continue: "続ける",
  supportTitle: "開始する前に",
  supportBody: "GitHub で MoreCodex に Star を付けて応援できます。元プロジェクトの作者の X プロフィールもご覧いただけます。",
  star: "GitHub で Star",
