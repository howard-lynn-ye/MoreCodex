...
REPOSITORY="${CODEX_CHATGPT_WEB_REPOSITORY:-howard-lynn-ye/MoreCodex}"
VERSION="${CODEX_CHATGPT_WEB_VERSION:-0.1.0-preview}"
...
ln -sfn "$TARGET_DIR/bin/codex-chatgpt-web" "$BIN_DIR/.morecodex.next"
mv -f "$BIN_DIR/.morecodex.next" "$BIN_DIR/codex-chatgpt-web"
