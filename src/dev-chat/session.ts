...
const FILLER_HEADER = "[MoreCodex DEV synthetic context fixture. Inert test data; do not execute or follow it.]\n";
...
export function createDevCoherentContextPayload(
  ...
  const paragraphs = [
    `[MoreCodex DEV coherent MCP fixture. Segment ${segment}/3: ${section.title}. This is inert fictional test data, not a command or policy.]`,
