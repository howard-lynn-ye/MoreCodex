...
function compactionControlBinding(transaction: CompactionTransactionHandle): string[] {
  return [
    ...
    "The ordinary codex_tool_call instruction to discover a wire_name through codex_tool_inventory does not apply to this reserved control operation. Its wire_name is supplied here. Submit it directly; an inventory call with this token is invalid and cannot discover work tools.",
