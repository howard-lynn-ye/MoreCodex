...
export interface CodexProviderConfig {
  ...
  chatgptWeb?: {
    ...
    /** Existing browser's user-approved connection; authentication remains in that browser. */
    externalBrowser?: import("./external-browser").ExternalBrowserOptions;
    /** Enrolled browser account and workspace; checked before every Web turn. */
    accountIdentity?: import("./chatgpt-account").ChatGptAccountIdentity;
    modelBinding?: import("./web-accounts").WebModelBinding;
    webModelDefinition?: import("./web-model-definition").WebModelDefinition;
