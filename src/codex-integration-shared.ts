...
interface CodexIntegrationJournalBase {
  active: boolean;
  configPath: string;
  installed: {
...
export type CodexIntegrationJournal = CodexIntegrationJournalBase & (
  | { version: 10; modelCatalog?: undefined }
  | { version: 11; modelCatalog: ManagedCodexModelCatalog }
);
...
export interface InstallCodexIntegrationOptions {
  ...
  /** Opt in to Codex's native, dynamically regenerated model catalogue. */
